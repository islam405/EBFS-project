...
public class ContactsPageTest extends TestBase{
	...
	@Test(priority=2)
	public void verifyContactsSend(){
		ExtentTestManager.getTest().log(Status.INFO, "Verify Contact sent");
		contactsPage.selectSubjectHeadingByVisibleText("Customer service");
		contactsPage.enterEmail();
		contactsPage.enterOrderReferance();
		contactsPage.clickSendBtn();
	}
